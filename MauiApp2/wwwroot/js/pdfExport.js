...
window.pdfExport = {
    ...
    exportSalesSummaryToPdf: function (tableId, reportNumber, issueDate, startDate, endDate, groupBy, totalTransactions, totalRevenue, totalTax, totalSubtotal, averageTransaction, filename) {
        ...
        try {
            ...
            // Summary boxes with borders (4 boxes in a row - using wider boxes for portrait)
            ...
            const metrics = [
                ...
                { label: 'Total Tax', value: formatCurrency(totalTax), icon: '📋' },
                { label: 'Avg Transaction', value: formatCurrency(averageTransaction), icon: '📈' }
            ];
